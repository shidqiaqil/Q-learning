										...
										<ul class="dropdown-menu dropdown-content" aria-labelledby="navbarDropdown">
											...
											<li class="dropdown-submenu">
												...
												<ul class="dropdown-menu" role="menu">
													...
													<li class="dropdown-divider"></li>
													<li class="dropdown-item" style="padding:0%"><a style="color:#14bdee;" href="materi-naturaljoin.php">Natural Join</a></li>
													<li class="dropdown-divider"></li>
					...
					<div class="course_container" style="margin-top:6%;">
						...
						<div style="margin-top:3%;" class="course_info d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">
							...
							<div class="course_info_item">
								...
								<div class="course_info_text"><a href="#">05:00</a></div>
							</div>

							<!-- Course Info Item -->
							<div class="course_info_item">
								<div class="course_info_title">Materi :</div>
								<div class="course_info_text"><a href="#">Natural Join</a></div>
							</div>
						...
						<div class="course_image">
							<iframe width="100%" height="350px" src="https://www.youtube.com/embed/nqkbjWKV1yY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
						</div>
						...
						<div class="course_tabs_container">
							...
							<div class="tab_panels">
								...
								<div class="tab_panel active">
									<div class="tab_panel_title text-center"><b>NATURAL JOIN</b></div>
									<div class="tab_panel_content">
										<div class="tab_panel_text">
											<p style="text-indent:50px;text-align: justify;">Natural Join akan mengambil baris dari tabel-tabel yang mempunyai kesamaan pada semua nama kolom. jika ada sebuah kolom yang mempunyai nama yang sama\
                      akan tetapi tipe datanya berbeda, maka akan mengembalikan eror message</p>
                      <p style="text-indent:50px;text-align: justify;">Asumsi tabel member dan transaksi mempunyai satu kolom yang sama, yaitu kolom idmembber </p>
                      <p class="text-center"><b>SELECT idmember, nmMember, tgltransaksi from member natural join transaksi</b></p>
                      ...
                      <table class="table table-bordered text-dark">
                        ...
                        <p class="text-center" style="margin-top: 2%;"><b>SELECT * FROM kota INNER JOIN propinsi ON kota.id_provinsi = provinsi_id;</b></p>

											<p style="text-indent:50px;text-align: justify;">Perintah ON kota.id_propinsi = propinsi.id, berarti akan menampilkan data-data yang mempunyai nilai sama antara id_propinsi pada table kota dan id pada table propinsi. Yang artinya data tersebut berelasi.</p>
