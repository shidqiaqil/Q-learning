		...
		<div class="container" style="margin-top : 5%">
			...
			<form method="post" action="mailto:raizen@mail.utexas.edu?subject=Vocabulary Quiz 1" enctype="text/plain">
				...
				<P> 1. sytanx sql yang benar untuk menampilkan tabel first name dan last name adalah?
					<BR>
					<input type="radio" name="1.The word which means house is" value="maison">select firstname, lastname from employees
					<BR>
					<input type="radio" name="1.The word which means house is" value="quatre">select first_name, last_name from employees;
					<BR>
					<input type="radio" name="1.The word which means house is" value="soleil">select First_name, last_name from Employees;
					<BR>
					<input type="radio" name="1.The word which means house is" value="poisson">select from Employees
					<BR>
				</p>

				<P> 2. syntax sql untuk menampilkan first name dan salary yang lebih dari 20000 adalah y
					<BR>
					<input type="radio" name="2. The word which means fish is" value="maison">select first_name salary 20000 from employees
					<BR>
					<input type="radio" name="2. The word which means fish is" value="valise">select first_name salary from employees
					<BR>
					<input type="radio" name="2. The word which means fish is" value="soleil">select first_name salary where salary=20000 employees;
					<BR>
					<input type="radio" name="2. The word which means fish is" value="poisson">select first_name salary where salary=salary 20000 from employees;
					<BR>
				</p>

				<P>3. The word which means "suitcase" is:
					<BR>
					<input type="radio" name="3. The word which means suitcase is" value="renard">renard
					<BR>
					<input type="radio" name="3. The word which means suitcase is" value="valise">valise
					<BR>
					<input type="radio" name="3. The word which means suitcase is" value="soleil">soleil
					<BR>
					<input type="radio" name="3. The word which means suitcase is" value="poisson">poisson
					<BR>
				</p>
